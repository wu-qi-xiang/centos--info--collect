...
# Leave empty to disable inbound WeCom ChatOps. This value is never stored or returned.
WECOM_CHATOPS_WEBHOOK_SECRET = os.environ.get('WECOM_CHATOPS_WEBHOOK_SECRET', '')
if WECOM_CHATOPS_WEBHOOK_SECRET and len(WECOM_CHATOPS_WEBHOOK_SECRET) < 32:
	raise ImproperlyConfigured('WECOM_CHATOPS_WEBHOOK_SECRET 至少需要 32 个字符')
...
DEVOPS_SCHEDULER_POLL_SECONDS = env_int(os.environ, 'DEVOPS_SCHEDULER_POLL_SECONDS', 5)
DEVOPS_SCHEDULER_LEASE_SECONDS = env_int(os.environ, 'DEVOPS_SCHEDULER_LEASE_SECONDS', 600)
DEVOPS_SCHEDULER_MONITOR_INTERVAL_SECONDS = env_int(os.environ, 'DEVOPS_SCHEDULER_MONITOR_INTERVAL_SECONDS', 60)
DEVOPS_SCHEDULER_ALERTMANAGER_INTERVAL_SECONDS = env_int(os.environ, 'DEVOPS_SCHEDULER_ALERTMANAGER_INTERVAL_SECONDS', 60)
DEVOPS_SCHEDULER_ONCALL_INTERVAL_SECONDS = env_int(os.environ, 'DEVOPS_SCHEDULER_ONCALL_INTERVAL_SECONDS', 60)
DEVOPS_SCHEDULER_SERVICE_SLO_INTERVAL_SECONDS = env_int(os.environ, 'DEVOPS_SCHEDULER_SERVICE_SLO_INTERVAL_SECONDS', 300)
DEVOPS_SCHEDULER_COMPLIANCE_INTERVAL_SECONDS = env_int(os.environ, 'DEVOPS_SCHEDULER_COMPLIANCE_INTERVAL_SECONDS', 86400)
DEVOPS_SCHEDULER_AGENT_HEALTH_INTERVAL_SECONDS = env_int(os.environ, 'DEVOPS_SCHEDULER_AGENT_HEALTH_INTERVAL_SECONDS', 60)
DEVOPS_SCHEDULER_INTEGRATION_HEALTH_INTERVAL_SECONDS = env_int(
	os.environ, 'DEVOPS_SCHEDULER_INTEGRATION_HEALTH_INTERVAL_SECONDS', 300,
)
DEVOPS_SCHEDULER_OPERATOR_SCAN_INTERVAL_SECONDS = env_int(
	os.environ, 'DEVOPS_SCHEDULER_OPERATOR_SCAN_INTERVAL_SECONDS', 300,
)
for _scheduler_setting in (
	'DEVOPS_SCHEDULER_POLL_SECONDS', 'DEVOPS_SCHEDULER_LEASE_SECONDS',
	'DEVOPS_SCHEDULER_MONITOR_INTERVAL_SECONDS', 'DEVOPS_SCHEDULER_ALERTMANAGER_INTERVAL_SECONDS',
	'DEVOPS_SCHEDULER_ONCALL_INTERVAL_SECONDS', 'DEVOPS_SCHEDULER_SERVICE_SLO_INTERVAL_SECONDS',
	'DEVOPS_SCHEDULER_COMPLIANCE_INTERVAL_SECONDS', 'DEVOPS_SCHEDULER_AGENT_HEALTH_INTERVAL_SECONDS',
	'DEVOPS_SCHEDULER_INTEGRATION_HEALTH_INTERVAL_SECONDS', 'DEVOPS_SCHEDULER_OPERATOR_SCAN_INTERVAL_SECONDS',
):
	if globals()[_scheduler_setting] <= 0:
		raise ImproperlyConfigured('%s 必须是正整数' % _scheduler_setting)
AGENT_HEARTBEAT_TIMEOUT_SECONDS = env_int(os.environ, 'AGENT_HEARTBEAT_TIMEOUT_SECONDS', 600)
if AGENT_HEARTBEAT_TIMEOUT_SECONDS <= 0:
	raise ImproperlyConfigured('AGENT_HEARTBEAT_TIMEOUT_SECONDS 必须是正整数')
PLATFORM_PUBLIC_BASE_URL = os.environ.get('PLATFORM_PUBLIC_BASE_URL', '').rstrip('/')
WECOM_APPROVAL_LINK_TTL_SECONDS = env_int(os.environ, 'WECOM_APPROVAL_LINK_TTL_SECONDS', 900)
if WECOM_APPROVAL_LINK_TTL_SECONDS <= 0:
	raise ImproperlyConfigured('WECOM_APPROVAL_LINK_TTL_SECONDS 必须是正整数')
